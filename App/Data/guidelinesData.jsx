  ...
  const data = {
    ...
    rows: [
        ...
        },
        {
          ...
          description: "Department of Environment, Forestry and Fisheries (DEFF) following the introduction of the Management Effectiveness Tracking Tool (METT-SA) to track protected area management effectiveness, has identified cultural heritage survey, inventory, planning, and condition assessment in relation to planned objectives as a gap in the management of cultural heritage resources in Protected Areas in South Africa.",
          year: 2017,
