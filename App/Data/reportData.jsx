  ...
  const data = {
    ...
    rows: [
        ...
        },
        {
          ...
          description: 'The NCCRP notes that the measurement and monitoring of climate change responses are critical in ensuring their effective implementation, and that South Africa, through the coordination of the Department of Environment, Forestry and Fisheries (DEF), will design and publish the country\'s Climate Change Response Monitoring and Evaluation (M&E) System. Details of this M&E system are outlined in specific sections of the NCCRP.',
          year: 2015,
