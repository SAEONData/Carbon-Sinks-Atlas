  ...
  const data = {
    ...
    rows: [
      ...
      },
      {
        ...
        description: "Outcome 10 of the MTSF calls for a report on the state of climate change science and technology in South Africa to be provided to Cabinet by the DSI and the Department of Environment, Forestry and Fisheries (DEFF) every two years. This is the first such report.",
        year: 2017,
