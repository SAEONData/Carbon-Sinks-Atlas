...
class Footer extends React.Component {
  ...
  render() {
    ...
    <div className="col-md-3">
        <h4><b>SAEON ODP</b></h4>
        <a onClick={(event) => {event.preventDefault(); window.open("http://elearning.ccis.saeon.ac.za");}}><img src={logoSaeon} style={{maxHeight: '82px', marginBottom: '15px', marginLeft: '-30px'}} /></a>
    ...
    <div className="col-md-3 footer-funding">
        <h4><b>Funding</b></h4>
        <img src="https://ccis.environment.gov.za/df4a473d960cba109f32b0bfc40ad717.jpg" />
        <div className="row align-items-center">
        <div className="col-md-4"><img src={logoCsir} /></div>
        <div className="col-md-8"><img src={logoGis} /></div>
        </div>
        </div>
</div>
