    ...
    return (
      <>
        ...
        <section className="ea-content-full light-bg">
          ...
          {/* <h3 className="mt-5 mb-3">Land cover classes in</h3> */}
          <div className="row align-items-center">
            <div className="col-md-6">

            {/* <p>Table 1 summarises</p> */}
        ...
        <section className="light-bg pt-5 pb-4">
          <div className="container">
            {/* <h3>Table 1. Drivers of </h3> */}
            <table className="table table-bordered table-hover table-striped ZA-EC">
            <tbody>xxx</tbody></table>
          
          {/* <h3 className="mt-5 mb-3">Land cover classes in 2018 </h3> */}
          <div className="row">
            <div className="col-md-6">
            {/* <p>Soilnc conditions.</p> */}
            </div>
            <div className="col-md-6">
            {/* <p>Table 2. Estimated Soil Organic Carbon (SOC</p> */}
            </div>
          </div>
          <table className="table table-bordered table-hover mt-3 table-striped">
                <tbody>xxx</tbody></table>
          {/* <small>Note,erm rates of los</small> */}
          </div>
        </section>
      </>
    )
