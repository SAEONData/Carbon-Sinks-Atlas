...
import HarryGwalaPDF from '../../../../content/pdfs/districts/Harry_Gwala.pdf'
        ...
        <section className="ea-content-full light-bg">
          <div className="container mt-4 pt-5 pb-5">
            ...
            <div className="row mb-4 align-items-center">
              ...
              <a class="btn btn-ea-green btn-rounded w-100" href={HarryGwalaPDF} target="_blank"><i class="fa fa-file-pdf-o"></i> Download this document</a>
              </div>
            </div>
